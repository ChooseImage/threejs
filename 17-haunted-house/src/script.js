...
const graveGermetry = new THREE.BoxBufferGeometry(0.6, 0.8, 0.2);
...
for(let i=0; i< 50; i++){
    ...
    const grave = new THREE.Mesh(graveGermetry, graveMaterial);
...
const tick = () =>
{
    ...
    ghost2.position.z = (Math.sin(ghost2Angle) * 4) + Math.sin(ghost2Angle) * 2.5;
